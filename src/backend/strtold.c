...
longdouble ld_strtold(const char *p,char **endp)
{
        longdouble ldval;
        int exp;
...
extern "C" longdouble ld_strtold(const char *p,char **endp);
...
void main()
{
    ...
    errno = 0;
//  ld = ld_strtold("0x1.FFFFFFFFFFFFFFFEp16383", NULL);
    ld = ld_strtold("0x1.FFFFFFFFFFFFFFFEp-16382", NULL);
