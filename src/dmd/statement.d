...
extern (C++) final class TryCatchStatement : Statement
{
    Statement _body;
    Catches* catches;
    version(NoBackend) Catches* removedcatches; // removed due to body being nothrow
...
extern (C++) final class Catch : RootObject
{
    ...
    extern (D) this(const ref Loc loc, Type type, IdentifierAtLoc ident, Statement handler)
    {
