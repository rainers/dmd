...
extern (C++) final class DotIdExp : UnaExp
{
    ...
    static DotIdExp create(const ref Loc loc, Expression e, IdentifierAtLoc ident)
    {
...
extern (C++) class CatAssignExp : BinAssignExp
{
    ...
    extern (D) this(const ref Loc loc, EXP tok, int size, Expression e1, Expression e2)
    {
        super(loc, tok, size, e1, e2);
    }
...
extern (C++) final class IdentityExp : BinExp
{
    ...
    extern (D) this(EXP op, const ref Loc loc, Expression e1, Expression e2, const ref Loc oploc)
    {
