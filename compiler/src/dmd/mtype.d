...
extern (C++) abstract class Type : ASTNode
{
    ...
    final Type copy() nothrow const
    {
        ...
        version(LanguageServer) // assume GC
            ...
            void* p = allocmemoryNoFree(sizeTy[ty], alignTy[ty]);
...
extern (C++) final class Parameter : ASTNode
{
    ...
    extern (D) this(Loc loc, STC storageClass, Type type, IdentifierAtLoc ident, Expression defaultArg, UserAttributeDeclaration userAttribDecl, UnpackDeclaration unpack)
    {
        this.loc = loc;
        this.type = type;
        version (LanguageServer)
    ...
    static Parameter create(Loc loc, STC storageClass, Type type, IdentifierAtLoc ident, Expression defaultArg, UserAttributeDeclaration userAttribDecl, UnpackDeclaration unpack)
    {
