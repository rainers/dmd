...
FuncDeclaration buildOpAssign(StructDeclaration sd, Scope* sc)
{
    ...
    fparams.push(new Parameter(loc, STC.nodtor, sd.type, makeIdentifierAtLoc(Id.p), null, null));
...
FuncDeclaration buildXopEquals(StructDeclaration sd, Scope* sc)
{
    ...
    auto parameters = new Parameters();
    parameters.push(new Parameter(loc, STC.ref_ | STC.const_, sd.type, makeIdentifierAtLoc(Id.p), null, null));
...
FuncDeclaration buildXopCmp(StructDeclaration sd, Scope* sc)
{
    ...
    Expression e1 = new IdentifierExp(loc, Id.This);
    Expression e2 = new IdentifierExp(loc, Id.p);
    Expression e = new CallExp(loc, new DotIdExp(loc, e1, makeIdentifierAtLoc(Id.cmp)), e2);
    fop.fbody = new ReturnStatement(loc, e);
    uint errors = global.startGagging(); // Do not report errors
    Scope* sc2 = sc.push();
    sc2.stc = 0;
...
private DtorDeclaration buildWindowsCppDtor(AggregateDeclaration ad, DtorDeclaration dtor, Scope* sc)
{
    ...
    //   return (void*) this;
    // }
    Parameter delparam = new Parameter(Loc.initial, STC.undefined_, Type.tuns32, makeIdentifierAtLoc(Identifier.idPool("del")), new IntegerExp(dtor.loc, 0, Type.tuns32), null);
...
private CtorDeclaration generateCopyCtorDeclaration(StructDeclaration sd, const StorageClass paramStc, const StorageClass funcStc)
{
    ...
    fparams.push(new Parameter(Loc.initial, paramStc | STC.ref_ | STC.return_ | STC.scope_, structType, makeIdentifierAtLoc(Id.p), null, null));
