...
FuncDeclaration buildOpAssign(StructDeclaration sd, Scope* sc)
{
    ...
    auto fparams = new Parameters(new Parameter(loc, STC.nodtor, sd.type, makeIdentifierAtLoc(Id.p), null, null));
...
FuncDeclaration buildXopEquals(StructDeclaration sd, Scope* sc)
{
    ...
    auto parameters = new Parameters(new Parameter(loc, STC.ref_ | STC.const_, sd.type, makeIdentifierAtLoc(Id.p), null, null));
...
private DtorDeclaration buildWindowsCppDtor(AggregateDeclaration ad, DtorDeclaration dtor, Scope* sc)
{
    ...
    //   return (void*) this;
    // }
    Parameter delparam = new Parameter(Loc.initial, STC.none, Type.tuns32, makeIdentifierAtLoc(Identifier.idPool("del")), new IntegerExp(dtor.loc, 0, Type.tuns32), null);
...
private CtorDeclaration generateCtorDeclaration(StructDeclaration sd, const STC paramStc, const STC funcStc, bool move)
{
    ...
    auto fparams = new Parameters(new Parameter(Loc.initial, paramStc | stc, structType, makeIdentifierAtLoc(Id.p), null, null));
