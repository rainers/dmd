            ...
            case TOK.parameters:
                {
                    ...
                    foreach (i, arg; tded.isTypeFunction().parameterList)
                    {
                        ...
                        if (e.tok2 == TOK.parameters && arg.defaultArg && arg.defaultArg.op == EXP.error)
                            return setError();
                        args.push(new Parameter(arg.loc, arg.storageClass, arg.type, makeIdentifierAtLoc((e.tok2 == TOK.parameters) ? arg.ident : null), (e.tok2 == TOK.parameters) ? arg.defaultArg : null, arg.userAttribDecl));
                    }
                    tded = new TypeTuple(args);
                    break;
                }
